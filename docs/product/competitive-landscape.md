...
### nunu.ai (Zurich, ex-Waveline / ex-GenerAI; ETH spinout)
- **What they do:** Vision-based "Unembodied Minds" agents that play commercial games via screen capture + emulated keyboard/mouse — explicitly framed as **game QA replacement**. Pitch: "50% reduction in manual testing costs." Recent demo: agents autonomously completing the ~30-minute Hogwarts Legacy tutorial unaided. Lightweight SDK option for studios that prefer engine integration. Long-term thesis is "general-purpose unembodied minds" with a public side-quest into quadruped robotics — game QA is the training ground, not the final market ([Hartmann Capital thesis](https://www.hartmanncapital.com/news-insights/why-were-backing-nunu-ai-transforming-game-qa-with-unembodied-minds); [YC company page](https://www.ycombinator.com/companies/nunu-ai)).
- **Customers:** **Warner Bros, Scopely, Roboto Games** named publicly ([VentureBeat Mar 2025](https://venturebeat.com/games/nunu-ai-raises-6m-for-ai-agents-dubbed-unembodied-minds-for-game-testing/)).
- **Funding:** **$8M total** — $2M pre-seed (2024) + $6M seed (March 2025) co-led by **a16z Speedrun** and **Tirta Ventures**, with **Y Combinator**, Boost VC, Hartmann Capital, and angels participating ([The AI Insider Mar 2025](https://theaiinsider.tech/2025/03/14/nunu-ai-receives-6m-seed-funding-to-advance-ai-agents-for-game-testing-and-playability/), [VentureBeat](https://venturebeat.com/games/nunu-ai-raises-6m-for-ai-agents-dubbed-unembodied-minds-for-game-testing/), [ETH SPH project page](https://sph.ethz.ch/projects/nunu-ai-ex-waveline-ex-generai)).
- **Technical approach:** Multimodal vision agents reading the screen + simulated input; same input surface Nova uses for the Android emulator, but framed as a general-game vision pipeline. No public methodology around persona portfolios, persistent memory across sessions, or simulated affect — their public material is task-execution / "agents that play like humans," not player-experience modelling. **Lightweight SDK** option suggests they sell both integrationless and integrated variants depending on studio appetite.
- **Why they are the Goliath, but a Goliath playing a different game:** Nunu sells to **QA Directors** ("does the build crash, do the agents finish the tutorial, can we cut 50% of manual test cost"). Nova sells to **Product Directors / UA Managers** ("will the casual persona churn at world 3 because the energy timer feels punitive — what's the D7/ARPDAU impact"). **Different buyer, different budget, different pitch.** This is the single most important reason the Nova **Cognitive Audit & Prediction Platform** category pivot (away from the original "automated playtesting" QA framing) was load-bearing — keeping the QA framing would have walked Nova straight into nunu's lane with 1/40th the funding.
- **The 60-day-clock risk:** Nunu has the vision pipeline and the AAA distribution channel (Scopely, WB) to add an "emotional state" / "frustration" / "retention prediction" column to their dashboard at any time. If they realise affect-driven prediction is a higher-margin SKU than QA replacement, they can ship it in a sprint and distribute it overnight. Nova's **only durable defence** is scientific rigour — a Phase 0.7 cliff test that mathematically validates affect predicts churn cliffs. Without it, Nova has nothing nunu can't build in a weekend. **Calendar alert: Week 8 (≈2026-06-28).** If nunu announces ANY feature touching "player psychology," "retention prediction," "frustration," "engagement modelling," or "persona portfolio," the landscape has shifted and the Nova methodology should be open-sourced immediately to claim the academic-authority moat before nunu colonises it commercially.
- **Sources:** [The AI Insider funding](https://theaiinsider.tech/2025/03/14/nunu-ai-receives-6m-seed-funding-to-advance-ai-agents-for-game-testing-and-playability/), [VentureBeat](https://venturebeat.com/games/nunu-ai-raises-6m-for-ai-agents-dubbed-unembodied-minds-for-game-testing/), [Hartmann Capital thesis](https://www.hartmanncapital.com/news-insights/why-were-backing-nunu-ai-transforming-game-qa-with-unembodied-minds), [YC company page](https://www.ycombinator.com/companies/nunu-ai), [ETH SPH project page](https://sph.ethz.ch/projects/nunu-ai-ex-waveline-ex-generai). Full deep-dive in [casterai-deep-dive.md](./casterai-deep-dive.md) (research entry-point was a red-team flag for "CasterAI" that did not resolve to a real entity; nunu.ai is the realistic adjacent competitor and the document is preserved as a negative-finding audit trail).
...
- **nunu.ai's $8M + a16z Speedrun + Tirta + AAA logos (Warner Bros, Scopely, Roboto Games).** The closest competitor by a wide margin — vision pipeline, simulated input, named buyers, and a credible robotics-adjacent narrative for follow-on rounds. They are playing a different game today (QA replacement, sold to QA Directors), but they have everything they need to add an "emotional state" / "retention prediction" column to their dashboard and ship into Nova's lane in a sprint. The Phase 0.7 cliff test is the only durable defence — without academic-grade methodology validation, Nova has nothing nunu can't build in a weekend. **Week 8 calendar alert set (≈2026-06-28).**
